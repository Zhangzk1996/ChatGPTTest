...
public class HolidayController {
    ...
    public CustomResponse removeHolidays(Set<Holiday> holidays) {
        // if holidays is empty, return
        if (CollectionUtils.isEmpty(holidays)) {
            return new CustomResponse(400, "Holidays is empty", null);
        }
    ...
    @RequestMapping(value = "/getNextHolidayByCountryCode", method = RequestMethod.GET, produces = "application/json", consumes = "application/json")
    ...
    @RequestMapping(value = "/getNextYearHolidayByCountryCode", method = RequestMethod.GET, produces = "application/json", consumes = "application/json")
    ...
    @RequestMapping(value = "/isHoliday", method = RequestMethod.POST, produces = "application/json", consumes = "application/json")
